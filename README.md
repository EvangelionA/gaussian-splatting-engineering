...
<p align="center">
  <a href="https://evangeliona.github.io/"><img src="https://img.shields.io/badge/Project Page-gaussian splatting engineering WIP-red.svg" alt="Project Page"/></a>
  <a href="https://space.bilibili.com/3546851796060172/upload/video"><img src="https://img.shields.io/badge/Bilibili Page-gaussian splatting engineering-blue.svg" alt="Project Page"/></a>
...
### **Creativefield**
 SoftWare | Object | Introduction | Demo |
 ---- | ---- | ---- | ----
 [PlayCanvas](https://developer.playcanvas.com/user-manual/gaussian-splatting/) | WEBGL+3DGS |  1.Creating Splats 2.Viewing Splats 3.Editing Splats 4.Building Splat-based Apps| <a><img height="100%" width="100%" alt= "web+3dgs.gif" src="./dataTestResult/3dgs-app/web+3dgs.gif"> </a>| 
 ||||
